...
public class ArrayListRunner
{
    public static void main( String[] args )
    {
        ...
        System.out.println( "b) first name: " + firstName + "; last name: " + lastName );
        ...
        // h) Create a second ArrayList called names2 that is built by calling the ArrayList constructor that accepts another ArrayList as an argument.
        //      Pass names to the constructor to build names2. Then print the ArrayList.
